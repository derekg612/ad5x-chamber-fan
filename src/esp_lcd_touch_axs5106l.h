// Minimal I2C driver for the AXS5106L capacitive touch controller used on
// the Waveshare ESP32-S3-Touch-LCD-1.47. Adapted from the board's community
// Arduino demo (github.com/VolosR/Waveshare147Touch).
#pragma once
